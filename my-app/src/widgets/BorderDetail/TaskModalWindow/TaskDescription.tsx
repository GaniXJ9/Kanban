...
const TaskDescription = () => {
  ...
  const [value, setValue] = useState<string>(currentTask?.description || "");
  ...
  return (
    <div className="p-5 w-full border-r border-[#535252]">
      ...
      <textarea
        ...
        className="p-2 text-md h-36 font-normal first-letter:uppercase border text-slate-600 dark:text-slate-200 w-full mt-5 bg-slate-300 dark:bg-[#4c4b4b] rounded-lg"
        onChange={onChange}
        value={value}
      />
    </div>
