  ...
  return (
    <div
      className={clsx(
        ...
        "backdrop-blur-xl bg-gray-300/10 flex flex-col gap-5 border p-3 border-gray-300 lg:hover:border-black  justify-center rounded-md transition-all duration-500 lg:hover:-translate-y-1"
      )}
      key={feature.id}
    >
      {feature.icon && (
      ...
      <h1
        className={clsx(
          feature.icon ? "text-center text-lg" : "text-start text-md",
      ...
      <h3
        className={clsx(
          feature.icon ? "text-center text-md" : "text-start text-xs",
